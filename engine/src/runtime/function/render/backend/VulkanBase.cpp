...
bool RHIBase::shouldClose() {
	return glfwWindowShouldClose(instance.window);
}

void RHIBase::setupFrameBuffer() {
...
void RHIBase::recreateSwapChain() {
...
void RHIBase::endSingleTimeCommands(vk::CommandBuffer commandBuffer) {
	commandBuffer.end();
...
void RHIBase::copyBuffer(vk::Buffer srcBuffer, vk::Buffer dstBuffer, vk::DeviceSize size) {
...
vki::Instance& RHIBase::getInstance() {
	return instance;
}

void RHIBase::renderLoop() {
...
void RHIBase::nextFrame() {
	render();
}

void RHIBase::createSyncObjects() {
...
void RHIBase::destroySyncObjects() {
...
void RHIBase::createDescriptorPool() {
...
void RHIBase::createCommandPool() {
...
void RHIBase::createCommandBuffers() {
...
void RHIBase::createDepthStencil() {
